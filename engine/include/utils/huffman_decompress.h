#ifndef D2PORTABLE_UTILS_HUFFMAN_DECOMPRESS_H
#define D2PORTABLE_UTILS_HUFFMAN_DECOMPRESS_H
...
/**
 * Decompress data using Huffman encoding as used in MPQ files
 * 
...
#endif // D2PORTABLE_UTILS_HUFFMAN_DECOMPRESS_H